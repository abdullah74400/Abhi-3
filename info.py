...
# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '1807927334 1133549523').split()] # For Multiple Id Use One Space Between Each.
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002108939580').split()]  # For Multiple Id Use One Space Between Each.
...
O_DB_URI = environ.get('O_DB_URI', "mongodb+srv://agnakumaeObTF9P8KcHCuNSDN@cluster0.oahj2.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")   # This Db Is For Other Data Store
F_DB_URI = environ.get('F_DB_URI', "mongodb+srv://tejs25986:3OM5JLW2KmPlnr7S@cluster0.d6i8b.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")   # This Db Is For File Data Store
S_DB_URI = environ.get('S_DB_URI', "mongodb+srv://rom126652:evYRG6u5GucvzAQM@cluster0.wy1h0.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")   # This Db is for File Data Store When First Db Is Going To Be Full.
...
VERIFY_TUTORIAL = environ.get('VERIFY_TUTORIAL', 'https://t.me/Hindi_movie_uplod/36')

# If You Fill Second Shortner Then Bot Attach Both First And Second Shortner And Use It For Verify.
VERIFY_SECOND_SHORTNER = bool(environ.get('VERIFY_SECOND_SHORTNER', False))
# if verify second shortner is True then fill below url and api
VERIFY_SND_SHORTLINK_URL = environ.get('VERIFY_SND_SHORTLINK_URL', 'indiaearnx.com')
VERIFY_SND_SHORTLINK_API = environ.get('VERIFY_SND_SHORTLINK_API', '4648f3b9a330674316e0cf01a7b5e8611e4fcd8a')
...
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/Hindi_movie_uplod/36') # How Open Shortner Link Video Link , Channel Link Where You Upload Your Video.
